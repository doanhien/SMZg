...
void unfolding_egmResol( bool data = true, bool ele = true, bool barrel = true, int i = 0, TString cat = "rho_up")
{

  TString finame = "inputUnfold/SB_EE7to13_EE6to14/EGM_Resol/ZgToLLg_5f_responseMatrix_";
  TString suf = Form("isPVGood_ele_resol_%s_%d.root", cat.Data(), i);
  ...
  TString filename="output_EGM_Resol/Zg_Unfolding_Subtract_Bkg_";
