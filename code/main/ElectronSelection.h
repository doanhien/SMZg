...
/*
//Bool_t Electron_SMZg(vector<init> selectedEle, int i) {
void Electron_SMZg(vector<int> &selectedEle) {
...
void passEleId(vector<int> &selectedEle) {
...
void NoEleId(vector<int> &selectedEle) {
